...
#
# Created: Mon Jan  1 19:05:16 2007
...
class Ui_debunk2(object):
    def setupUi(self, debunk2):
        ...
        debunk2.resize(QtCore.QSize(QtCore.QRect(0,0,708,461).size()).expandedTo(debunk2.minimumSizeHint()))
        debunk2.setSizeGripEnabled(False)

        self.layoutWidget = QtGui.QWidget(debunk2)
        self.layoutWidget.setGeometry(QtCore.QRect(10,12,691,439))
